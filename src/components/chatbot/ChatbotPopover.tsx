...
//   #030957 → hsl(234 93% 18%)
//   #FFB900 → hsl(43 100% 50%)
...
const Inner: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <div
      dir="rtl"
      style={chatbotTheme}
      className="flex flex-col w-[calc(100vw-3rem)] sm:w-[380px] h-[560px] max-h-[calc(100vh-8rem)] bg-background rounded-2xl shadow-2xl border border-border overflow-hidden"
      onClick={(e) => e.stopPropagation()}
    >
      {/* Header */}
      <div className="bg-[hsl(var(--azabot-navy))] text-white px-4 py-3 flex items-center justify-between shrink-0">
        <button
          onClick={onClose}
      ...
      {/* Tabs */}
      <div className="bg-[hsl(var(--azabot-navy))] flex shrink-0">
        <button
      ...
      {tab === 'text' ? (
        ...
        <div className="bg-background flex flex-col flex-1 min-h-0">
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
            ...
            >
              <Mic className="h-9 w-9 text-[hsl(var(--azabot-navy))]" />
            </div>
          ...
          <div className="border-t border-border p-4 bg-card flex items-center justify-between shrink-0">
              ...
              <Button
                ...
                className={cn(
                  ...
                  isVoiceConnected
                    ...
                    : 'bg-[hsl(var(--azabot-gold))] hover:bg-[hsl(var(--azabot-gold)/0.9)] text-[hsl(var(--azabot-navy))]'
                )}
              >
...
const ChatbotPopover: React.FC<Props> = ({ onClose }) => {
  return (
