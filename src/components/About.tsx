        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <h2 className="text-2xl lg:text-3xl font-bold mb-6">
              العزب للمقاولات والتشطيبات <br />
              <span className="text-construction-accent">تاريخ من التميز والإبداع</span>
            </h2>
            <p className="text-base text-gray-600 mb-6 leading-relaxed">
              تأسست العزب للمقاولات منذ أكثر من 20 عاماً لتصبح واحدة من أهم الشركات الرائدة في مجال المقاولات والبناء في المملكة العربية السعودية ومصر. تخصصنا في تقديم خدمات متكاملة في مجال الإنشاء والتعمير بأعلى معايير الجودة والالتزام بالمواعيد.
            </p>
